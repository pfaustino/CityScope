...
export const SOURCES: SourceRecord[] = [
  ...
  },
  {
    ...
    updateFrequency: 'monthly',
    geographicCoverage: 'California agencies including Burbank PD',
    ...
    legalAccess: 'PUBLIC',
    howToObtain:
      'Download Crimes and Clearances from OpenJustice and filter to Burbank PD. These are annual agency totals, not geocoded incidents. CityScope does not display fabricated incident counts.',
    phase1Priority: 5,
  },
  {
    id: 'fbi-cde',
    ...
    datasetId: 'ORI CA0191200',
    authentication: 'API_KEY',
    rateLimit: 'api.data.gov key required',
    updateFrequency: 'monthly',
    geographicCoverage: 'Burbank PD (ORI CA0191200)',
